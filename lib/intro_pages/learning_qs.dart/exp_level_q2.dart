...
class expLevelQuestionTwo extends StatefulWidget {
  ...
  const expLevelQuestionTwo(
      {super.key, required this.user, required this.promptDetails});

  @override
  _expLevelQuestionTwoState createState() => _expLevelQuestionTwoState();
}

class _expLevelQuestionTwoState extends State<expLevelQuestionTwo> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Select your experience level in this topic',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        hint: Text('Ex. First Timer, Intermediate...'),
                        onChanged: (value) {
                          setState(() {
                            selectedExperienceLevel = value;
                            widget.promptDetails.experienceLevel =
