...
class hoursPerWeekQuestionThree extends StatefulWidget {
  final UserDetails user;
  final PromptDetails promptDetails;

  const hoursPerWeekQuestionThree({
    super.key,
    required this.user,
  ...
  @override
  _hoursPerWeekQuestionThreeState createState() =>
      _hoursPerWeekQuestionThreeState();
}

class _hoursPerWeekQuestionThreeState extends State<hoursPerWeekQuestionThree> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        onSubmitted: (value) {
                          final hoursPerWeek = int.tryParse(value);
                          widget.promptDetails.hoursPerWeek = hoursPerWeek!;
                          // Save the value and navigate to the AgePage
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => courseLengthQuestionFour(
                              user: widget.user,
